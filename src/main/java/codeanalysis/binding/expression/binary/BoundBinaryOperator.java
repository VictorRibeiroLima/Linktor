...
public final class BoundBinaryOperator {
    ...
    private static final List<BoundBinaryOperator> operators = Arrays.asList(
            ...
            new BoundBinaryOperator(SyntaxKind.HAT_TOKEN, BoundBinaryOperatorKind.BITWISE_XOR, Integer.class),
            ...
            new BoundBinaryOperator(SyntaxKind.HAT_TOKEN, BoundBinaryOperatorKind.BITWISE_XOR, Integer.class),
            new BoundBinaryOperator(SyntaxKind.HAT_TOKEN, BoundBinaryOperatorKind.BITWISE_XOR, Boolean.class),
